if shared.VapeExecuted then
	...
	local function vapeGithubRequest(scripturl)
		if not isfile("vape/"..scripturl) then
			local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/imlivinginmyhouse/Bedwars/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
			assert(suc, res)
